                  ...
                  <td className="px-4 py-3">
                    {u.role === "supervisor" ? (
                      <button
                        ...
                        className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus:outline-none disabled:opacity-50 ${u.can_create_case ? "bg-primary-600" : "bg-gray-200"}`}
                      >
                  ...
                  <td className="px-4 py-3">
                    {u.role === "supervisor" ? (
                      <button
                        ...
                        className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus:outline-none disabled:opacity-50 ${u.can_delete_case ? "bg-primary-600" : "bg-gray-200"}`}
                      >
